...
const Home = () => {
  ...
  <section className="relative min-h-[50vh] sm:min-h-[50vh] lg:min-h-screen overflow-hidden px-4 lg:px-8 flex items-start lg:items-center dark:bg-gray-900 transition-colors duration-300 pt-28 md:pt-0">
